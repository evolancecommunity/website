          ...
          <div className="w-full max-w-full flex flex-col md:flex-row items-center gap-4 sm:gap-6 lg:gap-8 xl:gap-12 px-2 sm:px-4">
            <div className="flex flex-col items-center md:items-start text-center md:text-left order-1 md:order-2">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                {/* Spotify - Real Brand Colors */}
                <div className="group flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-black rounded-full hover:scale-110 transition-all duration-300 shadow-lg">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="#1DB954" viewBox="0 0 24 24">
                ...
                {/* Apple Music - Real Brand Colors */}
                <div className="group flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full hover:scale-110 transition-all duration-300 shadow-lg" style={{background: 'linear-gradient(135deg, #FA233B 0%, #FB5C74 100%)'}}>
                ...
                {/* YouTube Music - Real Brand Colors */}
                <div className="group flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 bg-red-600 rounded-full hover:scale-110 transition-all duration-300 shadow-lg">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="white" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center justify-center min-h-[80vh]">
            ...
            <div className="mb-8 animate-fade-in" style={{ animationDelay: '1.5s', animationFillMode: 'both' }}>
              ...
              <p className="text-xl md:text-2xl text-white/70 font-light tracking-wider">
                First AI Platform for Human Emotional Intelligence
              </p>
            </div>
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-col space-y-3">
                ...
                <div className="flex space-x-3">
                  ...
                  {/* Founder LinkedIn */}
                  <a 
                    href="https://www.linkedin.com/in/indraneel24/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group bg-white/5 backdrop-blur-sm rounded-full p-3 border border-white/10 hover:border-purple-400/40 hover:bg-purple-500/10 transition-all duration-300"
                    title="Indraneel Bhattacharjee - Founder"
                  >
                    <svg 
                      className="w-5 h-5 text-white/70 group-hover:text-purple-400 transition-colors duration-300" 
                      fill="currentColor" 
                      viewBox="0 0 24 24"
                    >
